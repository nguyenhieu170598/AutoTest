...
public class umPloyment_3 extends BasePage{

    public umPloyment_3(WebDriver webDriver) {
        super(webDriver);
    }
    @FindBy(xpath="//input[@name='insurance_control'][@value='3']")
    ...
    public void gotoIns_3() throws InterruptedException {
        ...
        ra_answer3.click();
        Thread.sleep(1000);
        txtName.sendKeys("Nguyễn Hoàng 3");
        Thread.sleep(1000);
        txtDate.click();
        Thread.sleep(1000);
        btChooseDate.click();
        Thread.sleep(1000);
        txtPhone.sendKeys("0938058603");
        Thread.sleep(1000);
        txtId.sendKeys("212000322083");
