...
public class umPloyment_4 extends BasePage {

    public umPloyment_4(WebDriver webDriver) {
        super(webDriver);
    }
    ...
    public void gotoIns() throws InterruptedException {
        ...
        ra_answer3.click();
        Thread.sleep(1000);
        txtName.sendKeys("Nguyễn Hoàng 4");
        Thread.sleep(1000);
        txtDate.click();
        Thread.sleep(1000);
        btChooseDate.click();
        Thread.sleep(1000);
        txtPhone.sendKeys("0938058634");
        Thread.sleep(1000);
        txtId.sendKeys("212000322084");
