...
public class topup_Behind_Viettel_200 extends BasePage {
    public topup_Behind_Viettel_200(WebDriver webDriver) {
        super(webDriver);
    }
    ...
    @FindBy(xpath = "//form[@id='topup-form-postpaid']//div[@data-amount='200000']")
