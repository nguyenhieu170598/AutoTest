...
public class topup_Front_Viettel_50 extends BasePage{
    public topup_Front_Viettel_50(WebDriver webDriver) {
        super(webDriver);
    }
    ...
    @FindBy(xpath = "//div[@class='topup_option_contain']/div/div/div[3]")
