...
public class topup_Behind_Viettel_10 extends BasePage {
    public topup_Behind_Viettel_10(WebDriver webDriver) {
        super(webDriver);
    }
    ...
    @FindBy(xpath = "//form[@id='topup-form-postpaid']//div[@data-amount='10000']")
