...
public class topup_Behind_Viettel_20 extends BasePage {
    public topup_Behind_Viettel_20(WebDriver webDriver) {
        super(webDriver);
    }
    ...
    @FindBy(xpath = "//form[@id='topup-form-postpaid']//div[@data-amount='20000']")
