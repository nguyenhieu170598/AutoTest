...
public class topup_Behind_Viettel_50 extends BasePage {
    public topup_Behind_Viettel_50(WebDriver webDriver) {
        super(webDriver);
    }
    ...
    @FindBy(xpath = "//form[@id='topup-form-postpaid']//div[@data-amount='50000']")
